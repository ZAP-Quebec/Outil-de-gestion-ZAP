 ...
 *        into arrays.  ZAP separator is comma (',').
 *
 ...
 *        ZAP is that subsequent options overwrite the parameter value.
 *
 ...
 *        ZAP is that the value is simply boolean true regardless of
...
class Zend_Console_Getopt
{
    ...
    /**
     * ZAPs for getopt configuration are:
