    ...
    //implements Zend_Tool_Framework_Provider_DocblockManifestInterface
{
    ...
    public function create($path, $nameOfProfile = null, $fileOfProfile = null)
    {
        ...
        if ($profileData == '') {
            $profileData = $this->_getZAPProfile();
        }
    ...
    protected function _getZAPProfile()
    {
        $data = <<<EOS
...
<projectProfile type="default" version="1.10">
    <projectDirectory>
        ...
        <docsDirectory>
            <file filesystemName="README.txt" defaultContentCallback="Zend_Tool_Project_Provider_Project::getZAPReadmeContents"/>
        </docsDirectory>
        <libraryDirectory>
...
EOS;
    ...
    public static function getZAPReadmeContents($caller = null)
    {
