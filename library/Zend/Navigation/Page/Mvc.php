...
class Zend_Navigation_Page_Mvc extends Zend_Navigation_Page
{
    ...
    public function isActive($recursive = false)
    {
        if (!$this->_active) {
            ...
            if (!array_key_exists('module', $reqParams)) {
                $reqParams['module'] = $front->getZAPModule();
            }
            ...
            if (null !== $this->_module) {
                ...
                $myParams['module'] = $front->getZAPModule();
            }

            if (null !== $this->_controller) {
                $myParams['controller'] = $this->_controller;
            } else {
                $myParams['controller'] = $front->getZAPControllerName();
            }

            if (null !== $this->_action) {
                $myParams['action'] = $this->_action;
            } else {
                $myParams['action'] = $front->getZAPAction();
            }
     ...
     * @see getHref()
     *
     * @param  array|null $params        [optional] page params. ZAP is null
