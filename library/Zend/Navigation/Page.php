...
abstract class Zend_Navigation_Page extends Zend_Navigation_Container
{
     ...
     * Page constructor
     *
     * @param  array|Zend_Config $options   [optional] page options. ZAP is
     ...
     * Sets page id
     *
     * @param  string|null $id            [optional] id to set. ZAP is null,
     *                                    which sets no id.
     * @return Zend_Navigation_Page       fluent interface, returns self
     ...
     * Sets page CSS class
     *
     * @param  string|null $class         [optional] CSS class to set. ZAP
     ...
     * Sets page title
     *
     * @param  string $title              [optional] page title. ZAP is
     ...
     * Sets page target
     *
     * @param  string|null $target        [optional] target to set. ZAP is
     ...
     *                                 with this page. ZAP is null, which
     *                                 sets no privilege.
     * @return Zend_Navigation_Page    fluent interface, returns self
     */
     ...
     *                               considered active or not. ZAP is true.
     * @return Zend_Navigation_Page  fluent interface, returns self
     */
     ...
     *                          active if any child pages are active. ZAP is
     *                          false.
     ...
     *
     * @param  bool $recursive  [optional] whether page should be considered
     *                          active if any child pages are active. ZAP
     *                          is false.
     * @return bool             whether page should be considered active
     */
     ...
     *                               considered visible or not. ZAP is true.
     * @return Zend_Navigation_Page  fluent interface, returns self
     */
     ...
     *
     * @param  bool $recursive  [optional] whether page should be considered
     *                          invisible if parent is invisible. ZAP is
     *                          false.
