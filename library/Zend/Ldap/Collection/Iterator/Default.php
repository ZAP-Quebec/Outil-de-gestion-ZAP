 ...
 * @version    $Id: ZAP.php 20096 2010-01-06 02:05:09Z bkarwin $
 */

/**
 * Zend_Ldap_Collection_Iterator_ZAP is the default collection iterator implementation
 * using ext/ldap
 *
 * @category   Zend
 * @package    Zend_Ldap
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Ldap_Collection_Iterator_ZAP implements Iterator, Countable
{
     ...
     * - Zend_Ldap_Collection_Iterator_ZAP::ATTRIBUTE_TO_LOWER
     * - Zend_Ldap_Collection_Iterator_ZAP::ATTRIBUTE_TO_UPPER
     * - Zend_Ldap_Collection_Iterator_ZAP::ATTRIBUTE_NATIVE
     ...
     * @return Zend_Ldap_Collection_Iterator_ZAP Provides a fluent interface
     */
