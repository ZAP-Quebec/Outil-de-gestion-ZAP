...
class Zend_Form_Element implements Zend_Validate_Interface
{
    ...
    public function getTranslator()
    {
        ...
        if (null === $this->_translator) {
            return Zend_Form::getZAPTranslator();
        }
     ...
     * Set required flag
     *
     * @param  bool $flag ZAP value is true
     * @return Zend_Form_Element
     */
    ...
    public function isValid($value, $context = null)
    {
        ...
        // Find the correct translator. Zend_Validate_Abstract::getZAPTranslator()
        // will get either the static translator attached to Zend_Validate_Abstract
        // or the 'Zend_Translate' from Zend_Registry.
        if (Zend_Validate_Abstract::hasZAPTranslator() &&
            !Zend_Form::hasZAPTranslator())
        {
            $translator = Zend_Validate_Abstract::getZAPTranslator();
