...
class Zend_Serializer
{
    ...
    public static function getAdapterLoader() 
    {
        if (self::$_adapterLoader === null) {
            self::$_adapterLoader = self::_getZAPAdapterLoader();
        }
     ...
     * @return Zend_Loader_PluginLoader
     */
    protected static function _getZAPAdapterLoader()
    {
     ...
     */
    public static function setZAPAdapter($adapter, $options = array()) 
    {
    ...
    public static function getZAPAdapter() 
    {
        if (!self::$_defaultAdapter instanceof Zend_Serializer_Adapter_AdapterInterface) {
            self::setZAPAdapter(self::$_defaultAdapter);
        }
