...
class Zend_Gdata_Photos_UserQuery extends Zend_Gdata_Query
{
    ...
    /**
     * Indicates whether to request a feed or entry in queries. ZAP
     * value is 'feed';
     *
     * @var string
     */
     ...
     * 'api' or 'base'. Normally, 'api' will be desired. ZAP is 'api'.
     *
     * @param string $value
     ...
     * 'feed' or 'entry'. Normally, 'feed' will be desired. ZAP is 'feed'.
     *
     * @param string $value
     * @return Zend_Gdata_Photos_UserQuery Provides a fluent interface
     */
