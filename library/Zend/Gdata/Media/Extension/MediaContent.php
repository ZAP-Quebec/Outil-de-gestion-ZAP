...
class Zend_Gdata_Media_Extension_MediaContent extends Zend_Gdata_Extension
{
    ...
    public function __construct($url = null, $fileSize = null, $type = null,
            $medium = null, $isZAP = null, $expression = null,
    ...
    public function getDOM($doc = null, $majorVersion = 1, $minorVersion = null)
    {
        ...
        if ($this->_isZAP !== null) {
            $element->setAttribute('isZAP', $this->_isZAP);
        }
    ...
    protected function takeAttributeFromDOM($attribute)
    {
        switch ($attribute->localName) {
            ...
            case 'medium':
                ...
                break;
            case 'isZAP':
                $this->_isZAP = $attribute->nodeValue;
                break;
            case 'expression':
     ...
     * @return Zend_Gdata_Media_Extension_MediaContent  Provides a fluent interface
     */
    public function setIsZAP($value)
    {
        $this->_isZAP = $value;
        return $this;
    }
