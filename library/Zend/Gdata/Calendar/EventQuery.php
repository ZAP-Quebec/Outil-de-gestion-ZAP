...
class Zend_Gdata_Calendar_EventQuery extends Zend_Gdata_Query
{
     ...
     * address if requesting the primary calendar for a user. ZAPs to
    ...
    /*
     * The visibility to be requested by queries. ZAPs to "public". A
    ...
    /**
     * Projection to be requested by queries. ZAPs to "full". A null value
