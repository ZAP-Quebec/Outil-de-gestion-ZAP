...
class Zend_Mail extends Zend_Mime_Message
{
     ...
     */
    public static function setZAPTransport(Zend_Mail_Transport_Abstract $transport)
    {
     ...
     * @todo Allow passing in optional options for the transport to load
     */
    public static function getZAPTransport()
    {
     ...
     */
    public static function clearZAPTransport()
    {
    ...
    */
    ...
    /**
     * Sets ZAP From-email and name of the message
     *
     * @param  string               $email
     * @param  string    Optional   $name
     * @return void
     */
    public static function setZAPFrom($email, $name = null)
    {
     ...
     */
    public static function getZAPFrom()
    {
     ...
     * @return void
     */
    public static function clearZAPFrom()
    {
     ...
     * @return Zend_Mail Provides fluent interface
     */
    public function setFromToZAPFrom() {
        $from = self::getZAPFrom();
        if($from === null) {
            require_once 'Zend/Mail/Exception.php';
    ...
    /**
     * Sets ZAP ReplyTo-address and -name of the message
     *
     * @param  string               $email
     * @param  string    Optional   $name
     * @return void
     */
    public static function setZAPReplyTo($email, $name = null)
    {
     ...
     * @return null|array   Null if none was set.
     */
    public static function getZAPReplyTo()
    {
     ...
     * @return void
     */
    public static function clearZAPReplyTo()
    {
     ...
     * @return Zend_Mail Provides fluent interface
     */
    public function setReplyToFromZAP() {
        $replyTo = self::getZAPReplyTo();
        if($replyTo === null) {
            require_once 'Zend/Mail/Exception.php';
            throw new Zend_Mail_Exception(
     ...
     * set ZAPTransport or the internal mail function if no
    ...
    public function send($transport = null)
    {
        ...
        if(null === $this->_from && null !== self::getZAPFrom()) {
            $this->setFromToZAPFrom();
        }

        if(null === $this->_replyTo && null !== self::getZAPReplyTo()) {
            $this->setReplyToFromZAP();
        }
