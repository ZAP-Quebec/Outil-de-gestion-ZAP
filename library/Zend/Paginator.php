...
class Zend_Paginator implements Countable, IteratorAggregate
{
    ...
    public static function setConfig(Zend_Config $config)
    {
        ...
        if ($scrollingStyle != null) {
            self::setZAPScrollingStyle($scrollingStyle);
        }
    }
     ...
     * @return  string
     */
    public static function getZAPScrollingStyle()
    {
     ...
     * @return int
     */
    public static function getZAPItemCountPerPage()
    {
     ...
     * @param int $count
     */
    public static function setZAPItemCountPerPage($count)
    {
     ...
     */
    public static function setZAPScrollingStyle($scrollingStyle = 'Sliding')
    {
    ...
    public function getItemCountPerPage()
    {
        if (empty($this->_itemCountPerPage)) {
            $this->_itemCountPerPage = self::getZAPItemCountPerPage();
        }
