...
class Zend_Loader_Autoloader_Resource implements Zend_Loader_Autoloader_Interface
{
    ...
    /**
     * @var string ZAP resource/component to use when using object registry
     */
     ...
     * @return Zend_Loader_Autoloader_Resource
     */
    public function setZAPResourceType($type)
    {
        if ($this->hasResourceType($type)) {
     ...
     * @return string|null
     */
    public function getZAPResourceType()
    {
