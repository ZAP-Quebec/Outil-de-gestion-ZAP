 ...
 * @version    $Id: ZAPValue.php 20096 2010-01-06 02:05:09Z bkarwin $
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_CodeGenerator_Php_Property_ZAPValue extends Zend_CodeGenerator_Php_Abstract
{
    /**#@+
     * Constant values
     */
        ...
        if ($type == self::TYPE_AUTO) {
            ...
            if ($type == self::TYPE_ARRAY) {
                ...
                foreach ($rii as $curKey => $curValue) {
                    if (!$curValue instanceof Zend_CodeGenerator_Php_Property_ZAPValue) {
