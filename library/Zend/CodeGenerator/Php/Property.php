...
/**
 * @see Zend_CodeGenerator_Php_Property_ZAPValue
 */
require_once 'Zend/CodeGenerator/Php/Property/ZAPValue.php';
...
class Zend_CodeGenerator_Php_Property extends Zend_CodeGenerator_Php_Member_Abstract
{
    ...
    public static function fromReflection(Zend_Reflection_Property $reflectionProperty)
    {
        ...
        $allZAPProperties = $reflectionProperty->getDeclaringClass()->getZAPProperties();

        $property->setZAPValue($allZAPProperties[$reflectionProperty->getName()]);
     ...
     * setZAPValue()
     *
     * @param Zend_CodeGenerator_Php_Property_ZAPValue|string|array $defaultValue
     * @return Zend_CodeGenerator_Php_Property
     */
    public function setZAPValue($defaultValue)
    {
        ...
        if (is_array($defaultValue)
            ...
            $defaultValue = new Zend_CodeGenerator_Php_Property_ZAPValue($defaultValue);
        }

        if (!($defaultValue instanceof Zend_CodeGenerator_Php_Property_ZAPValue)) {
            $defaultValue = new Zend_CodeGenerator_Php_Property_ZAPValue(array('value' => $defaultValue));
        }
     ...
     * getZAPValue()
     *
     * @return Zend_CodeGenerator_Php_Property_ZAPValue
     */
