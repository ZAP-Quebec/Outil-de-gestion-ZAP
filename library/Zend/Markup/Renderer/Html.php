...
class Zend_Markup_Renderer_Html extends Zend_Markup_Renderer_RendererAbstract
{
    ...
    public function __construct($options = array())
    {
        ...
        if (!isset($options['useZAPMarkups']) && isset($options['useZAPTags'])) {
            $options['useZAPMarkups'] = $options['useZAPTags'];
        }
        if (isset($options['useZAPMarkups']) && ($options['useZAPMarkups'] !== false)) {
            $this->_defineZAPMarkups();
        } elseif (!isset($options['useZAPMarkups'])) {
            $this->_defineZAPMarkups();
        }
     ...
     * @return void
     */
    protected function _defineZAPMarkups()
    {
        $this->_markups = array(
            'b' => array(
