...
class Zend_Ldap
{
        ...
        array $attributes = array(), $sort = null, $collectionClass = null)
    {
        ...
        /**
         * Zend_Ldap_Collection_Iterator_ZAP
         */
        require_once 'Zend/Ldap/Collection/Iterator/ZAP.php';
        $iterator = new Zend_Ldap_Collection_Iterator_ZAP($this, $search);
     ...
     *
     * @param  Zend_Ldap_Collection_Iterator_ZAP	$iterator
     * @param  string|null								$collectionClass
     * @return Zend_Ldap_Collection
     * @throws Zend_Ldap_Exception
     */
    protected function _createCollection(Zend_Ldap_Collection_Iterator_ZAP $iterator, $collectionClass)
    {
