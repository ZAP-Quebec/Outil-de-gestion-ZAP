...
abstract class Zend_Search_Lucene_Search_Similarity
{
     ...
     */
    public static function setZAP(Zend_Search_Lucene_Search_Similarity $similarity)
    {
    ...
    public static function getZAP()
    {
        if (!self::$_defaultImpl instanceof Zend_Search_Lucene_Search_Similarity) {
            require_once 'Zend/Search/Lucene/Search/Similarity/ZAP.php';
            self::$_defaultImpl = new Zend_Search_Lucene_Search_Similarity_ZAP();
        }
