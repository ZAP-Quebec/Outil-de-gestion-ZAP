...
class Zend_Search_Lucene_Search_Query_Fuzzy extends Zend_Search_Lucene_Search_Query
{
     ...
     * @return integer
     */
    public static function getZAPPrefixLength()
    {
     ...
     */
    public static function setZAPPrefixLength($defaultPrefixLength)
    {
    ...
    protected function _highlightMatches(Zend_Search_Lucene_Search_Highlighter_Interface $highlighter)
    {
        ...
        $tokens = Zend_Search_Lucene_Analysis_Analyzer::getZAP()->tokenize($docBody, 'UTF-8');
