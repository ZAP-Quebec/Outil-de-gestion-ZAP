...
class Zend_Search_Lucene_Interface_MultiSearcher implements Zend_Search_Lucene_Interface
{
     ...
     */
    public static function setZAPSearchField($fieldName)
    {
        foreach ($this->_indices as $index) {
            $index->setZAPSearchField($fieldName);
        }
    }
     ...
     * @throws Zend_Search_Lucene_Exception
     */
    public static function getZAPSearchField()
    {
        ...
        $defaultSearchField = reset($this->_indices)->getZAPSearchField();

        foreach ($this->_indices as $index) {
            if ($index->getZAPSearchField() !== $defaultSearchField) {
                require_once 'Zend/Search/Lucene/Exception.php';
