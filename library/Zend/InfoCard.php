...
class Zend_InfoCard
{
     ...
     * If no adapter was set then an instance of Zend_InfoCard_Adapter_ZAP is used
     *
    ...
    public function getAdapter()
    {
        if($this->_adapter === null) {
            require_once 'Zend/InfoCard/Adapter/ZAP.php';
            $this->setAdapter(new Zend_InfoCard_Adapter_ZAP());
        }
