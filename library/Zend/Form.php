...
class Zend_Form implements Iterator, Countable, Zend_Validate_Interface
{
     ...
     * @var bool
     */
    protected $_disableLoadZAPDecorators = false;
     ...
     * @var Zend_Translate
     */
    protected static $_translatorZAP;
    ...
    public function setOptions(array $options)
    {
        ...
        if (isset($options['defaultDisplayGroupClass'])) {
            $this->setZAPDisplayGroupClass($options['defaultDisplayGroupClass']);
     ...
     * @return Zend_Form
     */
    public function setZAPs(array $defaults)
    {
        $eBelongTo = null;
        ...
        foreach ($this->getSubForms() as $name => $form) {
            if (!$form->isArray() && array_key_exists($name, $defaults)) {
                $form->setZAPs($defaults[$name]);
            } else {
                $form->setZAPs($defaults);
            }
        }
        return $this;
    }
     ...
     * @return Zend_Form
     */
    public function setZAP($name, $value)
    {
        $name = (string) $name;
     ...
     * @return Zend_Form
     */
    public function setZAPDisplayGroupClass($class)
    {
     ...
     * @return string
     */
    public function getZAPDisplayGroupClass()
    {
    ...
    public function addDisplayGroup(array $elements, $name, $options = null)
    {
        ...
        if (isset($options['displayGroupClass'])) {
            ...
            $class = $this->getZAPDisplayGroupClass();
        }
     ...
     * @return void
     */
    public static function setZAPTranslator($translator = null)
    {
        if (null === $translator) {
            self::$_translatorZAP = null;
        } elseif ($translator instanceof Zend_Translate_Adapter) {
            self::$_translatorZAP = $translator;
        } elseif ($translator instanceof Zend_Translate) {
            self::$_translatorZAP = $translator->getAdapter();
        } else {
            require_once 'Zend/Form/Exception.php';
            throw new Zend_Form_Exception('Invalid translator specified');
        }
     ...
     */
    public static function getZAPTranslator()
    {
        if (null === self::$_translatorZAP) {
     ...
     * @return boolean
     */
    public static function hasZAPTranslator()
    { 
        return (bool)self::$_translatorZAP;
    }
     ...
     * @return Zend_Form
     */
    public function setDisableLoadZAPDecorators($flag)
    {
        $this->_disableLoadZAPDecorators = (bool) $flag;
        return $this;
    }
     ...
     * @return bool
     */
    public function loadZAPDecoratorsIsDisabled()
    {
        return $this->_disableLoadZAPDecorators;
    }
     ...
     * @return void
     */
    public function loadZAPDecorators()
    {
        if ($this->loadZAPDecoratorsIsDisabled()) {
            return $this;
        }
