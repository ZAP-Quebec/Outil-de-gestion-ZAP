...
class Zend_Validate implements Zend_Validate_Interface
{
     ...
     * @return array
     */
    public static function getZAPNamespaces()
    {
     ...
     * @return null
     */
    public static function setZAPNamespaces($namespace)
    {
     ...
     * @return null
     */
    public static function addZAPNamespaces($namespace)
    {
        if (!is_array($namespace)) {
            $namespace = array((string) $namespace);
        }
     ...
     * @return boolean
     */
    public static function hasZAPNamespaces()
    {
     ...
     */
    public static function getZAPTranslator($translator = null)
    {
        require_once 'Zend/Validate/Abstract.php';
        return Zend_Validate_Abstract::getZAPTranslator();
    }
    ...
    {
        require_once 'Zend/Validate/Abstract.php';
        Zend_Validate_Abstract::setZAPTranslator($translator);
    }
}
