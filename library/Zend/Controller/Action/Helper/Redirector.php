...
class Zend_Controller_Action_Helper_Redirector extends Zend_Controller_Action_Helper_Abstract
{
    ...
    public function setGotoSimple($action, $controller = null, $module = null, array $params = array())
    {
        ...
        $useZAPController = false;

        if (null === $controller && null !== $module) {
            $useZAPController = true;
        }
        ...
        if ($module == $dispatcher->getZAPModule()) {
            $module = '';
        }

        if (null === $controller && !$useZAPController) {
            $controller = $request->getControllerName();
            if (empty($controller)) {
                $controller = $dispatcher->getZAPControllerName();
            }
        }
