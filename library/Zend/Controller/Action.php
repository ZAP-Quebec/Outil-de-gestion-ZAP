...
abstract class Zend_Controller_Action implements Zend_Controller_Action_Interface
{
    ...
    public function initView()
    {
        ...
        if (empty($module) || !isset($dirs[$module])) {
            $module = $this->getFrontController()->getDispatcher()->getZAPModule();
        }
     ...
     * @param  string|null $action ZAPs to action registered in request object
     * @param  string|null $name Response object named path segment to use; defaults to null
     * @param  bool $noController  ZAPs to false; i.e. use controller name as subdir in which to search for view script
     * @return void
     */
     ...
     *
     * @param  string $action ZAPs to action registered in request object
     * @param  bool $noController  ZAPs to false; i.e. use controller name as subdir in which to search for view script
     * @return string
    ...
    /**
     * Proxy for undefined methods.  ZAP behavior is to throw an
