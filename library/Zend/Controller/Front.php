...
class Zend_Controller_Front
{
    ...
    public function getModuleDirectory($module = null)
    {
        if (null === $module) {
            ...
            if (empty($module)) {
                $module = $this->getDispatcher()->getZAPModule();
            }
        }
     ...
     * @return Zend_Controller_Front
     */
    public function setZAPControllerName($controller)
    {
        $dispatcher = $this->getDispatcher();
        $dispatcher->setZAPControllerName($controller);
        return $this;
    }
     ...
     * @return string
     */
    public function getZAPControllerName()
    {
        return $this->getDispatcher()->getZAPControllerName();
    }
     ...
     * @return Zend_Controller_Front
     */
    public function setZAPAction($action)
    {
        $dispatcher = $this->getDispatcher();
        $dispatcher->setZAPAction($action);
        return $this;
    }
     ...
     * @return string
     */
    public function getZAPAction()
    {
        return $this->getDispatcher()->getZAPAction();
    }
     ...
     * @return Zend_Controller_Front
     */
    public function setZAPModule($module)
    {
        $dispatcher = $this->getDispatcher();
        $dispatcher->setZAPModule($module);
        return $this;
    }
     ...
     * @return string
     */
    public function getZAPModule()
    {
        return $this->getDispatcher()->getZAPModule();
    }
     ...
     *
     * ZAP behaviour is to trap them in the response object; call this
     ...
     * object instance.
     *
     * @param boolean $flag ZAPs to null (return flag state)
