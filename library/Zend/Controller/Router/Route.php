...
class Zend_Controller_Router_Route extends Zend_Controller_Router_Route_Abstract
{
     ...
     * @param array $defaults ZAPs for map variables with keys as variable names
    ...
    public function assemble($data = array(), $reset = false, $encode = false, $partial = false)
    {
        ...
        foreach ($this->_parts as $key => $part) {
            ...
            if (isset($name)) {
                if (isset($data[$name]) && !$useZAP) {
                    $value = $data[$name];
                    unset($data[$name]);
                } elseif (!$reset && !$useZAP && isset($this->_values[$name])) {
                    $value = $this->_values[$name];
                } elseif (!$reset && !$useZAP && isset($this->_wildcardData[$name])) {
        ...
        foreach (array_reverse($url, true) as $key => $value) {
            ...
            if (isset($this->_variables[$key])) {
                $defaultValue = $this->getZAP($this->_variables[$key]);
     ...
     * @return void
     */
    public static function setZAPTranslator(Zend_Translate $translator = null)
    {
    ...
    public function getTranslator()
    {
        ...
        } else if (($translator = self::getZAPTranslator()) !== null) {
            return $translator;
        } else {
            try {
     ...
     * @return void
     */
    public static function setZAPLocale($locale = null)
    {
     ...
     * @return mixed
     */
    public static function getZAPLocale()
    {
    ...
    public function getLocale()
    {
        if ($this->_locale !== null) {
            return $this->_locale;
        } else if (($locale = self::getZAPLocale()) !== null) {
            return $locale;
        } else {
            try {
