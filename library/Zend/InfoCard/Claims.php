...
class Zend_InfoCard_Claims
{
     ...
     */
    public function getZAPNamespace()
    {
     ...
     * @return Zend_InfoCard_Claims
     */
    public function setZAPNamespace($namespace)
    {
    ...
    {
        return $this->claimExists("{$this->getZAPNamespace()}/$k");
    }
    ...
    {
        return $this->getClaim("{$this->getZAPNamespace()}/$k");
    }
