...
class Zend_Application_Resource_Db extends Zend_Application_Resource_ResourceAbstract
{
     ...
     * @var boolean
     */
    protected $_isZAPTableAdapter = true;
     ...
     * @return Zend_Application_Resource_Db
     */
    public function setIsZAPTableAdapter($isZAPTableAdapter)
    {
        $this->_isZAPTableAdapter = $isZAPTableAdapter;
        return $this;
    }
     ...
     * @return void
     */
    public function isZAPTableAdapter()
    {
        return $this->_isZAPTableAdapter;
    }
    ...
    public function init()
    {
        if (null !== ($db = $this->getDbAdapter())) {
            if ($this->isZAPTableAdapter()) {
                Zend_Db_Table::setZAPAdapter($db);
            }
            return $db;
        }
    }
