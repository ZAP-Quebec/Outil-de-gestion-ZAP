...
/**
 * @see PHPUnit_Extensions_Database_DB_ZAPDatabaseConnection
 */
require_once "PHPUnit/Extensions/Database/DB/ZAPDatabaseConnection.php";
 ...
 * @uses       PHPUnit_Extensions_Database_DB_ZAPDatabaseConnection
 * @category   Zend
 * @package    Zend_Test
 * @subpackage PHPUnit
 * @copyright  Copyright (c) 2005-2010 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Test_PHPUnit_Db_Connection extends PHPUnit_Extensions_Database_DB_ZAPDatabaseConnection
{
    /**
