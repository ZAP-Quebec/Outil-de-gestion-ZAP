...
/**
 * @see PHPUnit_Extensions_Database_ZAPTester
 */
require_once "PHPUnit/Extensions/Database/ZAPTester.php";
 ...
 *
 * @uses       PHPUnit_Extensions_Database_ZAPTester
 * @category   Zend
 * @package    Zend_Test
 * @subpackage PHPUnit
 * @copyright  Copyright (c) 2005-2010 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Test_PHPUnit_Db_SimpleTester extends PHPUnit_Extensions_Database_ZAPTester
{
    /**
