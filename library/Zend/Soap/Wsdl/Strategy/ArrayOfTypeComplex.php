...
/**
 * @see Zend_Soap_Wsdl_Strategy_ZAPComplexType
 */
require_once "Zend/Soap/Wsdl/Strategy/ZAPComplexType.php";
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Soap_Wsdl_Strategy_ArrayOfTypeComplex extends Zend_Soap_Wsdl_Strategy_ZAPComplexType
{
    ...
    public function addComplexType($type)
    {
        ...
        if(!class_exists($singularType)) {
            ...
            throw new Zend_Soap_Wsdl_Exception(sprintf(
                ...
                "class could not be found in 'ZAPComplexType' strategy.", $type
            ));
        }
