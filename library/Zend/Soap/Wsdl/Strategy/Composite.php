...
class Zend_Soap_Wsdl_Strategy_Composite implements Zend_Soap_Wsdl_Strategy_Interface
{
    ...
    /**
     * ZAP Strategy of this composite
     *
     ...
     */
    public function __construct(array $typeMap=array(), $defaultStrategy="Zend_Soap_Wsdl_Strategy_ZAPComplexType")
    {
     ...
     */
    public function getZAPStrategy()
    {
        ...
        if( !($strategy instanceof Zend_Soap_Wsdl_Strategy_Interface) ) {
            ...
            throw new Zend_Soap_Wsdl_Exception(
                "ZAP Strategy for Complex Types is not a valid strategy object."
            );
        }
