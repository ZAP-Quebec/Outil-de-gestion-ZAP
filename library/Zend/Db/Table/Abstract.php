...
abstract class Zend_Db_Table_Abstract
{
    ...
    /**
     * ZAP Zend_Db_Adapter_Abstract object.
     *
    ...
    /**
     * ZAP cache for information provided by the adapter's describeTable() method.
     *
     * @var Zend_Cache_Core
     */
     ...
     * @return Zend_Db_Table_Abstract
     */
    public function setZAPSource($defaultSource = self::DEFAULT_NONE)
    {
     ...
     * @return Zend_Db_Table_Abstract
     */
    public function setZAPValues(Array $defaultValues)
    {
     ...
     * @return void
     */
    public static function setZAPAdapter($db = null)
    {
     ...
     */
    public static function getZAPAdapter()
    {
     ...
     * @return void
     */
    public static function setZAPMetadataCache($metadataCache = null)
    {
     ...
     */
    public static function getZAPMetadataCache()
    {
