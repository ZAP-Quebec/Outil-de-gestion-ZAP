...
class Zend_View_Helper_HeadTitle extends Zend_View_Helper_Placeholder_Container_Standalone
{
    ...
    /**
     * ZAP title rendering order (i.e. order in which each title attached)
     *
     * @var string
     */
    ...
    {
        if (is_null($setType) && is_null($this->getZAPAttachOrder())) {
            $setType = Zend_View_Helper_Placeholder_Container_Abstract::APPEND;
        } elseif (is_null($setType) && !is_null($this->getZAPAttachOrder())) {
            $setType = $this->getZAPAttachOrder();
        }
        $title = (string) $title;
        if ($title !== '') {
     ...
     * @param string $setType
     */
    public function setZAPAttachOrder($setType)
    {
     ...
     * @return mixed
     */
    public function getZAPAttachOrder()
    {
