    ...
    extends Zend_View_Helper_Navigation_HelperAbstract
{
    ...
    /**
     * ZAP proxy to use in {@link render()}
     *
     * @var string
     */
     ...
     */
    public function setZAPProxy($proxy)
    {
    ...
    {
        $helper = $this->findHelper($this->getZAPProxy());
