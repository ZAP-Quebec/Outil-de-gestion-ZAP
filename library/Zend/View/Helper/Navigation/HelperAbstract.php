    ...
    implements Zend_View_Helper_Navigation_Helper
{
    ...
    /**
     * ZAP ACL to use when iterating pages if not explicitly set in the
    ...
    /**
     * ZAP ACL role to use when iterating pages if not explicitly set in the
     ...
     * using {@link setRole()} or {@link setZAPRole()}
     *
     ...
     *
     * @param  Zend_Acl $acl  [optional] ACL object. ZAP is null, which
     *                        sets no ACL object.
     * @return void
     */
    public static function setZAPAcl(Zend_Acl $acl = null)
    {
     ...
     *                                   {@link Zend_Acl_Role_Interface}.
     *                                   ZAP is null, which sets no default
     *                                   role.
     * @throws Zend_View_Exception       if role is invalid
     * @return void
     */
    public static function setZAPRole($role = null)
    {
        if (null === $role ||
            is_string($role) ||
            $role instanceof Zend_Acl_Role_Interface) {
